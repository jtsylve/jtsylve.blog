...
<div class="error-page">
  <h1><s aria-hidden="true">504</s></h1>
  <svg class="error-icon" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true">
...
<div class="hero-row hero-row-3">
  <a href="/" class="hero-card hero-card-link">
    <span class="hero-label">Home</span>
    <h2>Back to the blog</h2>
    <p>View all posts and research.</p>
  </a>
  <a href="/apfs/" class="hero-card hero-card-link">
    <span class="hero-label">Series</span>
    <h2>APFS Internals</h2>
    <p>An 18-part deep dive into the Apple File System.</p>
  </a>
  <a href="{{ latest.url }}" class="hero-card hero-card-link">
    <span class="hero-label">Latest Post</span>
    <h2>{{ latest.title }}</h2>
    <p>{{ latest.excerpt | strip_html | truncatewords: 15 }}</p>
  </a>
</div>
